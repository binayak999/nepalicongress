...
export default {
  ...
  computed: {
    ...mapGetters(["allPartyConstitutionFrontend", "selectedLanguage"]),
    ...
    numberOfPage: function () {
      if (this.allPartyConstitutionFrontend) {
        return Math.ceil(this.allPartyConstitutionFrontend.length / this.rows);
      } else {
        return 0;
      }
    },
    paged: function () {
      if (this.allPartyConstitutionFrontend) {
        return this.allPartyConstitutionFrontend.slice(
  ...
  methods: {
    ...mapActions(["fetchPartyConstitutionFrontend"]),
  },
  created() {
    this.fetchPartyConstitutionFrontend();
