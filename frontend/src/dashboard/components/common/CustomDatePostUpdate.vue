          ...
          <v-form ref="form" v-model="valid" lazy-validation>
            ...
            <v-row>
              ...
              <v-col md="12" v-if="oldAttachment.length != 0">
                <h2 class="imagetitle">Attachment</h2>
                <div class="flexboxfile">
              ...
              <v-col md="12">
                <button class="btn btn-primary" v-if="!addnewmedias" @click="addMedia">
                  Add New Medias
                </button>
                <button class="btn btn-primary" v-if="addnewmedias" @click="addMedia">
                  No New Media
              ...
              <v-col md="6" v-if="addnewmedias">
                <v-file-input multiple label="Images" :chips="true" :show-size="true" :rules="imgrules" outlined
                  v-model="images" accept="image/*" prepend-icon="mdi-camera"></v-file-input>
              </v-col>
              <v-col md="6" v-if="addnewmedias">
...
export default {
  ...
  async created() {
    ...
    await this.fetchSingleDash(params);
    // setTimeout(() => {
    ...
    this.sort =
      this.singlePostAll.sort != undefined ? 0 : this.singlePostAll.sort;
    // }, 1500);
  },
};
</script>
