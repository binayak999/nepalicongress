        ...
        <v-col cols="8" class="formbox">
          <v-form ref="form" v-model="valid" lazy-validation>
            ...
            <v-row>
              ...
              <v-col md="6" v-if="fortitle == 'datehistory'">
              ...
              <v-col md="6">
                <v-file-input multiple label="Images" :chips="true" :show-size="true" outlined :rules="imgrules"
              ...
              <v-col md="6">
                <v-file-input multiple label="Documents" :chips="true" :show-size="true" outlined v-model="attachment"
    ...
    validate() {
      if (
        ...
        if (this.$refs.form.validate()) {
          let addPost;
          if (this.fortitle === "calendar-events") {
            addPost = {
              eng: {
                title: this.engTitle,
              ...
              eventRealDate: this.eventRealDate,
              sort: this.sort,
