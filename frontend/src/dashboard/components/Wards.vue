<template>
  <section>
        ...
        {{ payload.pradeshassemblyconstituency }} / {{ payload.municipality }} / {{payload.wardno}}
      </h4>
    <div v-if="!loading">
...
export default {
  ...
  async created() {
    await this.reportGeneration({
      ...
      municipality: this.payload.municipality,
      wardno: this.payload.wardno,
    });
