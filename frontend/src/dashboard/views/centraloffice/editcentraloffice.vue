...
export default {
      ...
      if (this.engTitle != "") {
        if (this.$refs.form.validate()) {
          let updateCommittee = {
            ...
            imageFile: "centraloffice",
            id: this.allSingleCentral._id,
          };

          this.$store.dispatch("updateCentralOffice", updateCommittee);
        }
      }
    },
    languageswitch(lang) {
  ...
  created() {
    ...
    this.fetchSingleCentral(this.$route.params.id);
    setTimeout(() => {
      this.nepTitle = this.allSingleCentral.nep.title;
      this.engTitle = this.allSingleCentral.eng.title;
      this.engPost = this.allSingleCentral.eng.post;
      this.nepPost = this.allSingleCentral.nep.post;
      this.sort1 = this.allSingleCentral.sort1;
      this.sort2 = this.allSingleCentral.sort2;
      this.facebookUrl = this.allSingleCentral.facebookUrl;
      this.twitterUrl = this.allSingleCentral.twitterUrl;
      this.instagramUrl = this.allSingleCentral.instagramUrl;
      this.oldImage = this.allSingleCentral.images;
      this.oldAttachment = this.allSingleCentral.attachment;
      this.sortConCat = this.allSingleCentral.sorts;
    }, 1500);
  },
};
</script>
