              ...
              <tbody>
                <tr v-for="(body, index) in allFilterData.posts" :key="index">
                  ...
                  <td class="width20">
                    ...
                    >
                      <v-btn class="my-3 primary"  @click="selectCircular(body)" small>Transfer</v-btn>
                    </div>
                  </td>
                </tr>
                <tr class="no-print">
...
import TrasferCicularForm from "../../components/circular/TransferMemberShipForm.vue";

export default {
  name: "TrasferCircularMember",
  components: {
    TitleBreadCrumb,
    TrasferCicularForm,
    // ChartAndTable,
