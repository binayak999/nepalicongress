    ...
    <div v-if="!loading">
      <div v-if="allOptionAction">
        ...
        <section v-if="loggedActiveStorage">
          ...
          <v-container class="kriyasil ml-10 mt-5">
            <v-row>
          ...
          <iframe
            src="https://www.ashesh.com.np/preeti-unicode/linkapi.php?api=0821z0k473"
            frameborder="0"
            scrolling="no"
            marginwidth="0"
            marginheight="0"
          ...
          <span style="color: gray; text-align: left">
            ...
            <a
              ...
              title="Preeti to Nepali Unicode"
              target="_top"
              style="text-decoration: none; color: gray"
              >Preeti to Nepali Unicode</a
            >
          </span>
                ...
                >
                  <v-row>
                    ...
                    <v-col md="4">
                      <label for>कोड</label>
                      <v-text-field
                        v-model="dateofkriyasil"
                        :rules="[workingformnumberRules.required]"
                        required
                        outlined
                        readonly
                      ></v-text-field>
                    ...
                    <v-col md="4">
                      ...
                      <v-text-field
                        v-model="activememberformnumber"
                        :rules="[workingformnumberRules.required]"
                        required
                        outlined
                      ></v-text-field>
                    ...
                    <v-col md="4">
                      ...
                      <v-text-field
                        v-if="workingformnumber != undefined"
                    ...
                    <v-col md="4">
                      ...
                      <v-text-field
                        ...
                        :rules="[workingformnumberRules.required]"
                        class="specific"
                        :label="changeToNepali(membername)"
                        required
                        outlined
                    ...
                    <v-col md="4">
                      ...
                      <v-text-field
                        class="specific"
                        v-model="fathermothername"
                        :rules="[workingformnumberRules.required]"
                        :label="changeToNepali(fathermothername)"
                        required
                        outlined
                        @keydown="changeToNepali"
                      ></v-text-field>
                    ...
                    <v-col md="4">
                      ...
                      <v-text-field
                        class="specific"
                        v-model="husbandwifename"
                        :label="changeToNepali(husbandwifename)"
                        required
                        outlined
                        @keydown="changeToNepali"
                      ></v-text-field>
                    ...
                    <v-col md="4">
                      ...
                      <v-text-field
                        ...
                        v-model="profession"
                        :rules="[workingformnumberRules.required]"
                        :label="changeToNepali(profession)"
                        required
                        outlined
                        @keydown="changeToNepali"
                      ></v-text-field>
                    ...
                    >
                      ...
                      <v-selection
                        ...
                        :options="allProvinceonly"
                        label="province"
                        :filterable="true"
                        @input="selectProvinceNW(province)"
                      ></v-selection>
                    </v-col>
                    ...
                    >
                      ...
                      <v-text-field
                        ...
                        "
                        readonly
                        v-model="allsubdomainProfile.subdomains[0].city"
                        :rules="[workingformnumberRules.required]"
                        required
                        outlined
                      ></v-text-field>
                      <v-text-field
                        ...
                        "
                        readonly
                        v-model="allsubdomainProfile.subdomains[0].nepname"
                        :rules="[workingformnumberRules.required]"
                        required
                        outlined
                      ></v-text-field>
                      <v-selection
                        ...
                        label="name"
                        :filterable="true"
                        @input="selectDistrictNW(district)"
                      ></v-selection>
                    </v-col>
                    ...
                    <v-col md="4">
                      <label for="">ठेगाना (बिदेशको)</label>
                      <v-text-field
                        v-if="
                          allsubdomainProfile.subdomains[0].category !=
                            'Nepalese People\'s Co-ordination Committee' ||
                    ...
                    <v-col md="4">
                      ...
                      <v-text-field
                        ...
                        required
                        outlined
                        placeholder="सडक ठेगाना, शहर, राज्य, जिप"
                        class="specific"
                        :label="changeToNepali(fullAddress)"
                        @keydown="changeToNepali"
                      ></v-text-field>
                    </v-col>
                    ...
                    <v-col md="4" class="d-none">
                      <label for>साविक प्रतिनिधि सभा क्षे.नं.</label>
                      <v-text-field
                        v-model="froRconstituencyNo"
                        outlined
                      ></v-text-field>
                    </v-col>
                    <v-col md="4" class="d-none">
                      ...
                      <v-text-field
                        class="specific"
                        v-model="savikmunicipality"
                        :label="changeToNepali(savikmunicipality)"
                        outlined
                        @keydown="changeToNepali"
                      ></v-text-field>
                    </v-col>
                  ...
                  <v-btn
                    :disabled="!valid"
                    color="success"
                    class="mr-4 ml-3 mt-3"
                    @click="validate"
                    >Add Active Member</v-btn
                  >
                </v-form>
              </v-col>
            </v-row>
...
export default {
  ...
  data() {
    return {
      ...
      wardno: "00",
      inclusivegroup: "",
      froRconstituencyNo: "N/A",
      savikmunicipality: "N/A",
      savikwardno: "N/A",
      phone: "",
      email: "",
      kaifiyat: "",
  ...
  methods: {
    ...
    regionFunc(code) {
      if (this.allsubdomainProfile.subdomains[0].parentSubdomain == null)
    ...
    validate() {
      if (this.$refs.form.validate()) {
        ...
        if (
          ...
          if (this.houseofrepresentative == "00") {
            alert("Please select house of representative");
            return;
          }
          if (this.pradeshassemblyconstituency == "00") {
            alert("Please select pradeshassembly constituency");
            return;
          }
          if (this.municipality == "00") {
          ...
          if (this.inclusivegroup == "") {
            alert("Please select inclusive group");
            return;
          }
        }
        let addCircular = {
          ...
          inclusivegroup:
            this.inclusivegroup != ""
              ? this.changeToNepali(this.inclusivegroup)
              : "N/A",
  ...
  async created() {
    ...
    if (
      ...
      if (
        this.allsubdomainProfile.subdomains &&
        this.allsubdomainProfile.subdomains.length > 0 &&
        this.allsubdomainProfile.subdomains[0].province
      ) {
        this.province = this.allsubdomainProfile.subdomains[0].province;
        this.district = this.allsubdomainProfile.subdomains[0].district;
      }
    } else {
    ...
    this.loading = false;
    // this.$router.push("/activeMembersubdomain")
  },
};
</script>
