      ...
      <div>
        <section class="pdfbox" v-if="phonedata">
          ...
          <table
            ...
            v-if="allSocialProfiles.results"
          >
            <thead>
              <tr>
                <th>S/N</th>
                <th>Social Profile</th>
                <th>Social Handle From</th>
              </tr>
            </thead>
            <tbody>
              <tr
                v-for="(body, index) in allSocialProfiles.results.data"
                :key="index"
              >
                <td>{{ index + 1 }}</td>
                <td class="flexbox">
                  <div v-if="body.socialmedia[0].link != ''">
                    <a :href="body.socialmedia[0].link" target="_blank"
                      ><span class="fbbg">{{ body.socialmedia[0].type }}</span>
                    </a>
                  </div>
                  <div v-if="body.socialmedia[1].link != ''">
                    <a :href="body.socialmedia[1].link" target="_blank"
                      ><span class="twbg">{{ body.socialmedia[1].type }}</span>
                    </a>
                  </div>
                  <div v-if="body.socialmedia[2].link != ''">
                    <a :href="body.socialmedia[2].link" target="_blank">
                      <span class="inbg">{{ body.socialmedia[2].type }}</span>
                    </a>
                  </div>
                </td>
                <td>{{ body.socialMediaOf }}</td>
              </tr>
            </tbody>
          </table>
          <ul class="pagination">
...
padding:0 5px;
  ...
  methods: {
    ...mapActions(["getSocialProfiles", "getReportsPhoneNumber"]),
    prev() {
      if (this.skip > 1) {
        this.skip -= 1;
