      ...
      <v-row>
        <v-col cols="8" class="formbox">
          <v-form ref="form" v-model="valid" lazy-validation>
            ...
            <v-row>
              <v-col md="12">
                <v-text-field v-model="facebookUrl" label="Facebook Url" required outlined></v-text-field>
              </v-col>
              <v-col md="12">
                <v-text-field v-model="twitterUrl" label="Twitter Url" required outlined></v-text-field>
              </v-col>
              <v-col md="12">
                <v-text-field v-model="instagramUrl" label="Instagram Url" required outlined></v-text-field>
              </v-col>
            </v-row>
            <v-row>
              <!-- <v-col md="12">
...
export default {
  ...
  data() {
    return {
      baseUrl: fileUrl,
      valid: true,
      title: "Update Central Committee",
      language: false,
      images: [],
      sorts: [0, 1, 2, 3, 4, 5],
      sortConCat: "00",
  ...
  methods: {
    ...mapActions(["fetchSingleCommittee"]),
    validate() {
      ...
      if (this.engTitle != "") {
        if (this.$refs.form.validate()) {
          let updateCommittee = {
            ...
            sort1: this.sort1,
            sort2: this.sort2,
            sorts: this.sortConCat,
            facebookUrl: this.facebookUrl,
            twitterUrl: this.twitterUrl,
            instagramUrl: this.instagramUrl,
            imageFile: "centralcommittee",
            id: this.allSingleCommittee._id,
          };

          this.$store.dispatch("updateCentralCommittee", updateCommittee);
        }
      }
    },
    languageswitch(lang) {
  ...
  created() {
    ...
    this.fetchSingleCommittee(this.$route.params.id);
    setTimeout(() => {
      this.nepTitle = this.allSingleCommittee.nep.title;
      this.engTitle = this.allSingleCommittee.eng.title;
      this.engPost = this.allSingleCommittee.eng.post;
      this.nepPost = this.allSingleCommittee.nep.post;
      this.sort1 = this.allSingleCommittee.sort1;
      this.sort2 = this.allSingleCommittee.sort2;
      this.facebookUrl = this.allSingleCommittee.facebookUrl;
      this.twitterUrl = this.allSingleCommittee.twitterUrl;
      this.instagramUrl = this.allSingleCommittee.instagramUrl;
      this.oldImage = this.allSingleCommittee.images;
        this.oldAttachment = this.allSingleCommittee.attachment;
      this.sortConCat = this.allSingleCommittee.sorts;
    }, 1500);
  },
};
</script>
